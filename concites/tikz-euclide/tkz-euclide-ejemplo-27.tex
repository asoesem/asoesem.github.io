...
keywords: [ortocentro, altitudes, triángulo, escaleno]
...
\begin{document}
    \begin{tikzpicture}
        ...
        \tkzDefLine[altitude](C,A,B) % altura en A
            \tkzGetPoint{a}

        \tkzDefLine[altitude](A,B,C) % altura en B
            \tkzGetPoint{b}
            
        \tkzDefLine[altitude](B,C,A) % altura en C
            \tkzGetPoint{c}
        ...
        \tkzMarkRightAngle(A,a,B) % ∠AaB
        \tkzMarkRightAngle(B,b,A) % ∠BbA
        \tkzMarkRightAngle(C,c,B) % ∠CcB
