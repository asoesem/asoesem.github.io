...
\begin{document}
    \begin{tikzpicture}
        ...
        \tkzFillAngle[fill=red!20](H,G,I)   % ∠HGI
        \tkzFillAngle[fill=blue!20](I,H,G)  % ∠IHG
        \tkzFillAngle[fill=green!20](G,I,H) % ∠GIH
        ...
        \tkzMarkAngle[arc=l](H,G,I)    % ∠HGI
        \tkzMarkAngle[arc=ll](I,H,G)   % ∠IHG
        \tkzMarkAngle[arc=lll](G,I,H)  % ∠GHI
